...
source_dir = "write here the path of folder where the files are downloaded"
dest_dir_sfx = write here the path
dest_dir_music = write here the path
dest_dir_video = write here the path
dest_dir_image = write here the path
dest_dir_documents = write here the path
